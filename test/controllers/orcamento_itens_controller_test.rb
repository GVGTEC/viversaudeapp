...
class OrcamentoItensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orcamento_item" do
    assert_difference('OrcamentoItem.count') do
      post orcamento_itens_url, params: { orcamento_item: { orcamento_id: @orcamento_item.orcamento_id, preco_total: @orcamento_item.preco_total, preco_unitario: @orcamento_item.preco_unitario, produto_id: @orcamento_item.produto_id, quantidade: @orcamento_item.quantidade } }
    end
  ...
  test "should update orcamento_item" do
    patch orcamento_item_url(@orcamento_item), params: { orcamento_item: { orcamento_id: @orcamento_item.orcamento_id, preco_total: @orcamento_item.preco_total, preco_unitario: @orcamento_item.preco_unitario, produto_id: @orcamento_item.produto_id, quantidade: @orcamento_item.quantidade } }
