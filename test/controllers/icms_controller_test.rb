...
class IcmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create icms' do
    assert_difference('Icms.count') do
      post icms_index_url,
           params: { icms: { aliquota_icms: @icms.aliquota_icms, aliquota_icms_st: @icms.aliquota_icms_st, estado: @icms.estado,
                             fcp_pc: @icms.fcp_pc, fcp_sn: @icms.fcp_sn, mva_icms_st: @icms.mva_icms_st } }
    end
