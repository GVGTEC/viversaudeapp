...
class ClienteContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente_contato" do
    assert_difference('ClienteContato.count') do
      post cliente_contatos_url, params: { cliente_contato: { cliente_id: @cliente_contato.cliente_id, email: @cliente_contato.email, nome: @cliente_contato.nome, telefone: @cliente_contato.telefone } }
    end
  ...
  test "should update cliente_contato" do
    patch cliente_contato_url(@cliente_contato), params: { cliente_contato: { cliente_id: @cliente_contato.cliente_id, email: @cliente_contato.email, nome: @cliente_contato.nome, telefone: @cliente_contato.telefone } }
