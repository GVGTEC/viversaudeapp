...
class AdministradoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradores_url, params: { administrador: { email: @administrador.email, empresa_id: @administrador.empresa_id, nome: @administrador.nome, senha: @administrador.senha } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { email: @administrador.email, empresa_id: @administrador.empresa_id, nome: @administrador.nome, senha: @administrador.senha } }
