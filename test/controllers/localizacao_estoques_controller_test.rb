...
class LocalizacaoEstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create localizacao_estoque" do
    assert_difference('LocalizacaoEstoque.count') do
      post localizacao_estoques_url, params: { localizacao_estoque: { local: @localizacao_estoque.local, observacao: @localizacao_estoque.observacao } }
    end
  ...
  test "should update localizacao_estoque" do
    patch localizacao_estoque_url(@localizacao_estoque), params: { localizacao_estoque: { local: @localizacao_estoque.local, observacao: @localizacao_estoque.observacao } }
